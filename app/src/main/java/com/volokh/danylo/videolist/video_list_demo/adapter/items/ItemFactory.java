...
public class ItemFactory {
    ...
    public static BaseVideoItem createItemFromUrl(String title,String url, int imageResource, Activity activity, VideoPlayerManager<MetaData> videoPlayerManager) throws IOException {
