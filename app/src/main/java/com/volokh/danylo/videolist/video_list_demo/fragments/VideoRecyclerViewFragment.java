...
public class VideoRecyclerViewFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            mList.add(ItemFactory.createItemFromUrl("aaa",
                    "http://test-user-bucketout.oss-cn-shanghai.aliyuncs.com/test-video/1865118177724264-1562398560.mp4" ,R.drawable.video_sample_1_pic, getActivity(), mVideoPlayerManager));
